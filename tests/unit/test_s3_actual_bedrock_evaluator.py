...
from apps.backend.assessment import S3ActualBedrockEvaluator, S3ActualEvidenceLoader
...
class S3ActualBedrockEvaluatorTest(unittest.TestCase):
    def test_returns_an_aws_actual_result_from_scoped_s3_evidence(self):
        ...
        result = S3ActualBedrockEvaluator(evidence_loader=loader, client=Client()).evaluate(
