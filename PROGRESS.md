...
- M1 sandbox readiness hardening: live work를 composition root의 승인 Model Profile에 결합하고,
  ...
  credential Secret 역할 분리, CloudFormation M1 parameter all-or-none·빈 CSV 요소·live Region 차단 및
  runbook 동기화를 완료. 최신 `dev` 통합 후 Ruff 244 files, Unit 415, Contract 98, Integration 9,
  Security 72, `cfn-lint` error 0, Assessment 25-call·Policy Catalog 11-item dry-run 통과
